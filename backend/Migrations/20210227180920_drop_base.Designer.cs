...
namespace backend.Migrations
{
    ...
    [Migration("20210227180920_drop_base")]
    partial class drop_base
    {
            ...
            modelBuilder.Entity("backend.models.Etapa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataFim = new DateTime(2021, 3, 29, 19, 9, 20, 193, DateTimeKind.Local).AddTicks(7038),
                            DataInicio = new DateTime(2021, 3, 29, 15, 9, 20, 192, DateTimeKind.Local).AddTicks(6293),
                            HoraFim = new DateTime(2021, 2, 27, 15, 9, 20, 193, DateTimeKind.Local).AddTicks(7064),
                            HoraInicio = new DateTime(2021, 2, 27, 15, 9, 20, 193, DateTimeKind.Local).AddTicks(7062)
                        },
                        new
                        {
                            Id = 2,
                            DataFim = new DateTime(2021, 3, 30, 19, 9, 20, 193, DateTimeKind.Local).AddTicks(9942),
                            DataInicio = new DateTime(2021, 3, 30, 15, 9, 20, 193, DateTimeKind.Local).AddTicks(9935),
                            HoraFim = new DateTime(2021, 2, 27, 15, 9, 20, 193, DateTimeKind.Local).AddTicks(9946),
                            HoraInicio = new DateTime(2021, 2, 27, 15, 9, 20, 193, DateTimeKind.Local).AddTicks(9945)
                        });
                });
            ...
            modelBuilder.Entity("backend.models.HorarioCafe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataFim = new DateTime(2021, 3, 29, 15, 24, 20, 194, DateTimeKind.Local).AddTicks(631),
                            DataInicio = new DateTime(2021, 3, 29, 17, 9, 20, 194, DateTimeKind.Local).AddTicks(625),
                            HoraFim = new DateTime(2021, 2, 27, 15, 9, 20, 194, DateTimeKind.Local).AddTicks(647),
                            HoraInicio = new DateTime(2021, 2, 27, 15, 9, 20, 194, DateTimeKind.Local).AddTicks(645)
                        },
                        new
                        {
                            Id = 2,
                            DataFim = new DateTime(2021, 3, 29, 15, 24, 20, 194, DateTimeKind.Local).AddTicks(2967),
                            DataInicio = new DateTime(2021, 3, 30, 17, 9, 20, 194, DateTimeKind.Local).AddTicks(2960),
                            HoraFim = new DateTime(2021, 2, 27, 15, 9, 20, 194, DateTimeKind.Local).AddTicks(2970),
                            HoraInicio = new DateTime(2021, 2, 27, 15, 9, 20, 194, DateTimeKind.Local).AddTicks(2969)
                        });
                });
