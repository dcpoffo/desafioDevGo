...
namespace backend.Migrations
{
    ...
    [Migration("20210227143059_AlteracaoCampos")]
            ...
            modelBuilder.Entity("backend.models.Etapa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataFim = new DateTime(2021, 3, 29, 15, 30, 58, 329, DateTimeKind.Local).AddTicks(2805),
                            DataInicio = new DateTime(2021, 3, 29, 11, 30, 58, 327, DateTimeKind.Local).AddTicks(3297),
                            HoraFim = new DateTime(2021, 2, 27, 11, 30, 58, 329, DateTimeKind.Local).AddTicks(2853),
                            HoraInicio = new DateTime(2021, 2, 27, 11, 30, 58, 329, DateTimeKind.Local).AddTicks(2849)
                        },
                        new
                        {
                            Id = 2,
                            DataFim = new DateTime(2021, 3, 30, 15, 30, 58, 329, DateTimeKind.Local).AddTicks(8328),
                            DataInicio = new DateTime(2021, 3, 30, 11, 30, 58, 329, DateTimeKind.Local).AddTicks(8309),
                            HoraFim = new DateTime(2021, 2, 27, 11, 30, 58, 329, DateTimeKind.Local).AddTicks(8336),
                            HoraInicio = new DateTime(2021, 2, 27, 11, 30, 58, 329, DateTimeKind.Local).AddTicks(8333)
                        });
                });
            ...
            modelBuilder.Entity("backend.models.HorarioCafe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataFim = new DateTime(2021, 3, 29, 11, 45, 58, 329, DateTimeKind.Local).AddTicks(9606),
                            DataInicio = new DateTime(2021, 3, 29, 13, 30, 58, 329, DateTimeKind.Local).AddTicks(9593),
                            HoraFim = new DateTime(2021, 2, 27, 11, 30, 58, 329, DateTimeKind.Local).AddTicks(9638),
                            HoraInicio = new DateTime(2021, 2, 27, 11, 30, 58, 329, DateTimeKind.Local).AddTicks(9635)
                        },
                        new
                        {
                            Id = 2,
                            DataFim = new DateTime(2021, 3, 29, 11, 45, 58, 330, DateTimeKind.Local).AddTicks(4603),
                            DataInicio = new DateTime(2021, 3, 30, 13, 30, 58, 330, DateTimeKind.Local).AddTicks(4589),
                            HoraFim = new DateTime(2021, 2, 27, 11, 30, 58, 330, DateTimeKind.Local).AddTicks(4612),
                            HoraInicio = new DateTime(2021, 2, 27, 11, 30, 58, 330, DateTimeKind.Local).AddTicks(4609)
                        });
                });
